  ...
  <html>
    ...
    <body>
      ...
      <form action="" method="get">
        ...
        <div class = "item">
          <label>Title</label>
          <input type="text" placeholder = "Ex. Analysis of Algothims">
        </div>
        
        <div class = "item">
          <label>Author's First Name</label>
          <input type="text" placeholder = "Ex. Micheal">
        </div>
        
        <div class = "item">
          <label>Author's Last Name</label>
          <input type="text" placeholder = "Ex. Cohem">
        </div>
        
        <div class = "item">
          <label>ISBN# </label>
          <input type="text" placeholder = "Ex. 123-1-1234-1234-1">
        </div>
        ...
        <div class = "item">
          <label>Class </label>
          <input type="text" placeholder = "Ex. CS-3112">
        </div>
